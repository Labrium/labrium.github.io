...
var TransformControlsGizmo = function () {
	...
	matYellowTransparent.color.set(0x0000ff);

	var matCyanTransparent = matWhiteTransparent.clone();
	matCyanTransparent.color.set(0xff0000);

	var matMagentaTransparent = matWhiteTransparent.clone();
	matMagentaTransparent.color.set(0x00ff00);

	var matYellow = gizmoMaterial.clone();
	matYellow.color.set(0xffff00);

	var matLineRed = gizmoLineMaterial.clone();
	matLineRed.linewidth = 3;
	matLineRed.color.set(0xff0000);

	var matLineGreen = gizmoLineMaterial.clone();
	matLineGreen.linewidth = 3;
	matLineGreen.color.set(0x00ff00);

	var matLineBlue = gizmoLineMaterial.clone();
	matLineBlue.linewidth = 3;
	matLineBlue.color.set(0x0000ff);

	var matLineCyan = gizmoLineMaterial.clone();
	matLineCyan.color.set(0xff0000);

	var matLineMagenta = gizmoLineMaterial.clone();
	matLineMagenta.color.set(0x00ff00);

	var matLineYellow = gizmoLineMaterial.clone();
	matLineYellow.color.set(0x0000ff);

	var matLineGray = gizmoLineMaterial.clone();
	matLineGray.blending = THREE.AdditiveBlending;
	matLineGray.color.set(0x787878);

	var matLineYellowTransparent = gizmoLineMaterial.clone();
	matLineYellowTransparent.color.set(0xffff00);
	matLineYellowTransparent.linewidth = 3;
	...
	var gizmoTranslate = {
		...
		XYZ: [
			[new THREE.Mesh(new THREE.OctahedronBufferGeometry(0.1, 1), matWhiteTransparent.clone()), [0, 0, 0], [0, 0, 0]]
		],
		XY: [
