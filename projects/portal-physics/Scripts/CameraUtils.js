var _va = /*@__PURE__*/ new THREE.Vector3(), // from pe to pa
...
function frameCorners( camera, bottomLeftCorner, bottomRightCorner, topLeftCorner, estimateViewFrustum ) {

	var pa = bottomLeftCorner, pb = bottomRightCorner, pc = topLeftCorner;
